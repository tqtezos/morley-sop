...
test_Ord_Ed25519_PublicKey = testBatch $ ord (const $ arbitrary @Ed25519.PublicKey)

test_Ord_Secp256k1_PublicKey :: TestTree
test_Ord_Secp256k1_PublicKey = testBatch $ ord (const $ arbitrary @Secp256k1.PublicKey)

test_Ord_P256_PublicKey :: TestTree
test_Ord_P256_PublicKey = testBatch $ ord (const $ arbitrary @P256.PublicKey)

test_Ord_PublicKey :: TestTree
test_Ord_PublicKey = testBatch $ ord (const $ arbitrary @PublicKey)
